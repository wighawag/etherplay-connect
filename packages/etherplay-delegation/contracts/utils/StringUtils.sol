...
library StringUtils {
    ...
    ///
    /// The other implementations of the delegation message therefore have to
    /// lowercase too, and the vectors file carries checksummed inputs precisely
    /// to catch one that forgot.
    ///
